...
const EVIDENCE_TAXONOMY=Object.freeze({LRP:'Learner Reflective Photographs',LRS:'Learner Reflective Statement',LRV:'Learner Reflective Video',LRA:'Learner Reflective Audio',DOC:'Supporting Document',WTS:'Witness Testimony Statement',RPL:'Recognition of Prior Learning',OTJ:'Off-the-Job Training',GLH:'Guided Learning Hours'});
...
function nvqEvidenceCodes(recordType,record={}){const type=String(recordType||'').toLowerCase();if(type==='observation')return '';return Object.freeze({photos:'LRP',statement:'LRS',video:'LRV',audio:'LRA',document:'DOC',witness:'WTS',rpl:'RPL',glh:'GLH'}[type]||'')}
