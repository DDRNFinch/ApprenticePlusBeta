const CACHE='apprentice-plus-v2-91-bob-semantic-080';
...
self.addEventListener('fetch',event=>{
 ...
 const isCoreFile=url.pathname.endsWith('/')||['index.html','app.js','functional-skills-bank.js',
  'trade-courses-bank.js','review-transfer.js','bob-foundation.js','bob-course-brain.js','bob-brain-bridge.js','bob-evidence-bridge.js','bob-language-brain.js','bob-semantic-brain.js','mcq-question-bank.js','mcq-engine.js','qrcode-browser.js','pdf-generator.js','specification-sheet.js','styles.css','cadmate.html','manifest.json','manifest.webmanifest','release-notes.json','service-worker.js'].some(name=>url.pathname.endsWith('/'+name));
 if(isCoreFile){
  event.respondWith(
