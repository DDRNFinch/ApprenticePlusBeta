...
self.addEventListener('fetch',event=>{
 ...
 const isCoreFile=url.pathname.endsWith('/')||['index.html','app.js','functional-skills-bank.js',
  'trade-courses-bank.js','review-transfer.js','mcq-question-bank.js','mcq-engine.js','analytics-foundation.js','analytics-integration.js','qrcode-browser.js','pdf-generator.js','specification-sheet.js','styles.css','cadmate.html','manifest.json','manifest.webmanifest','release-notes.json','service-worker.js'].some(name=>url.pathname.endsWith('/'+name));
 if(isCoreFile){
  event.respondWith(
