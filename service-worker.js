const CACHE='apprentice-plus-v2-32-monthly-refined';
const CURRENT_VERSION='V2.32';
...
const APP_SHELL=['./','./index.html','./styles.css?v=2.32','./qrcode-browser.js?v=1.1','./pdf-generator.js?v=2.31','./specification-sheet.js?v=1.1','./functional-skills-bank.js?v=1.1','./trade-courses-bank.js?v=1.1','./mcq-question-bank.js?v=1.1','./mcq-engine.js?v=1.1','./app.js?v=2.32','./review-transfer.js?v=1.1','./release-notes.json','./technical-drawing-viewer.html','./cadmate.html','./manifest.json','./manifest.webmanifest','./logo-apprentice-plus.png','./icon-192.png','./icon-512.png','./icon-1024.png','./apple-touch-icon.png','./favicon-32.png','./favicon-64.png'];
